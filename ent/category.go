...
func (e CategoryEdges) ContainsOrErr() ([]*Product, error) {
	if e.loadedTypes[0] {
...
// QueryContains queries the "contains" edge of the Category entity.
func (c *Category) QueryContains() *ProductQuery {
	return (&CategoryClient{config: c.config}).QueryContains(c)
}
