...
func (*Post) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case post.FieldTitle, post.FieldContent, post.FieldUsername, post.FieldUserIP, post.FieldPassword:
...
func (po *Post) String() string {
	...
	builder.WriteString(po.UserIP)
	builder.WriteString(", password=")
	builder.WriteString(po.Password)
